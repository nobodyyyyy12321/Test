      ...
      <main className="w-full max-w-2xl zen-card p-8">
        <div className="flex items-center justify-between mb-6">
          ...
          <div className="flex items-center gap-2">
            <Link href={`/${encodeURIComponent(name)}/record`} className="inline-flex items-center justify-center whitespace-nowrap px-3 py-2 border rounded-full bg-white text-black text-sm leading-none cursor-pointer hover:opacity-90 transition-opacity">紀錄</Link>
          ...
          <div className="w-40 flex flex-col items-center">
            ...
            {editing && (
              <>
                ...
                />
                <button type="button" className="mt-2 px-4 py-2 border rounded-full border-white text-white text-sm cursor-pointer hover:opacity-90 transition-opacity" onClick={() => fileInputRef.current?.click()}>選擇檔案</button>
              </>
            )}
          </div>
